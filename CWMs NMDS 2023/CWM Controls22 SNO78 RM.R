...
CWM.Sites22.rm$nrow <- c(1:144)

CWM.Sites22.controls.rm <-
  CWM.Sites22.rm[102:144, ] #Extract only control lakes
...
ggplot_build(CWM.22.Controls.rm)
